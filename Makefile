...
userspace/libc/syscalls.o: userspace/libc/syscalls.c
	$(CC) -O2 -g -Wall -Wextra -m64 -march=x86-64 -ffreestanding -fno-stack-protector -fno-PIE -no-pie -fno-pic -nostdlib -I. -c userspace/libc/syscalls.c -o userspace/libc/syscalls.o
...
initrd.tar: initrd/init.elf initrd/compositor.elf initrd/service_manager.elf initrd/keyboard_driver.elf initrd/mouse_driver.elf initrd/terminal.elf initrd/panel.elf initrd/audio_server.elf initrd/gemini.elf initrd/test_driver.o
